...
{
    /// <summary>
    /// Parses Python single-line comments that start with <c>#</c>.
    /// </summary>
    internal sealed class PythonCommentParser : CommentParser
    {
        /// <summary>Initialises the parser with the active settings instance.</summary>
        public PythonCommentParser(BetterCommentsSettings settings) : base(settings) { }
