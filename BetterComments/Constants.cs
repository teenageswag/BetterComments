namespace BetterComments
{
    internal static class Constants
    {
        ...
        public const string ContentTypeFSharp = "fsharp";
        public const string ContentTypeCpp = "C/C++";
        public const string ContentTypeJavaScript = "javascript";
        public const string ContentTypeTypeScript = "typescript";
        public const string ContentTypeRazorCSharp = "razor";
